...
(let* ((one 1.0d0) (zero 0.0d0))
  ...
  (defun zherk (uplo trans n k alpha a lda beta c ldc)
    (declare (type (array f2cl-lib:complex16 (*)) c a)
     (type (double-float) beta alpha) (type (f2cl-lib:integer4) ldc lda k n)
    ...
    (f2cl-lib:with-multi-array-data
      ...
      (prog ((temp #C(0.0d0 0.0d0)) (rtemp 0.0d0) (i 0) (info 0) (j 0) (l 0)
             (nrowa 0) (upper nil))
        (declare (type (f2cl-lib:complex16) temp) (type (double-float) rtemp)
