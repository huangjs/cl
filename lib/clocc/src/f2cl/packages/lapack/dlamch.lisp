...
(let ((lieee1 nil) (lbeta 0) (lrnd nil) (lt$ 0) (first$ nil))
  (declare (type f2cl-lib:logical lieee1 lrnd first$)
   (type (f2cl-lib:integer4) lbeta) (type (integer) lt$))
  ...
  (defun dlamc1 (beta t$ rnd ieee1)
    ...
    (prog ((a 0.0d0) (b 0.0d0) (c 0.0d0) (f 0.0d0) (one 0.0d0) (qtr 0.0d0)
           (savec 0.0d0) (t1 0.0d0) (t2 0.0d0) (lt$ 0))
...
(let* ((zero 0.0d0) (one 1.0d0))
  ...
  (defun dlamc5 (beta p emin ieee emax rmax)
    (declare (type (double-float) rmax) (type f2cl-lib:logical ieee)
...
(let ((lbeta 0)
  ...
  (declare (type (f2cl-lib:integer4) lbeta lemax lemin)
   (type (double-float) leps lrmax lrmin) (type (integer) lt$)
   (type f2cl-lib:logical first$ iwarn))
  (setq first$ f2cl-lib:%true%)
  (setq iwarn f2cl-lib:%false%)
  (defun dlamc2 (beta t$ rnd eps emin rmin emax rmax)
    (declare (type (double-float) rmax rmin eps) (type f2cl-lib:logical rnd)
  ...
  (let ((prec 0.0d0)
    ...
    (defun dlamch (cmach)
      ...
      (f2cl-lib:with-multi-array-data
        ...
        (prog ((rmach 0.0d0) (small 0.0d0) (t$ 0.0d0) (beta 0) (imax 0)
               (imin 0) (it 0) (lrnd nil) (dlamch 0.0d0))
