...
#define CLM_FILE2FRAME 47
#define CLM_SAMPLE2FILE 48
#define CLM_FRAME2FILE 49
...
#define CLM_FILE2FRAME_P(Arg)       ((CLM_VAR_TYPE(Arg) == CLM_FILE2FRAME) &&     (CLM_VAR_ADDR(Arg) != 0))
#define CLM_SAMPLE2FILE_P(Arg)      ((CLM_VAR_TYPE(Arg) == CLM_SAMPLE2FILE) &&    (CLM_VAR_ADDR(Arg) != 0))
#define CLM_FRAME2FILE_P(Arg)       ((CLM_VAR_TYPE(Arg) == CLM_FRAME2FILE) &&     (CLM_VAR_ADDR(Arg) != 0))
