...
(defun full-directory (path)
  ...
  #-excl (let ((files (map 'list #'filename->string
...
(def-optkey-fun make-fft-window ((type rectangular-window) size (beta 0.0) (mu 0.0))
  ;; mostly taken from
  ...
  (let* ((window (make-double-array size))
    ...
    (macrolet ((lw (&body code) 
      ...
      (cond ((= type rectangular-window) (lw (setf val 1.0)))
	    ...
	    ((= type dolph-chebyshev-window) (dolph-chebyshev dolph-chebyshev-window window beta 0.0))
	    ((= type samaraki-window) (dolph-chebyshev samaraki-window window beta 1.0))
	    ((= type ultraspherical-window) (dolph-chebyshev ultraspherical-window window beta mu))
...
(def-optkey-fun make-two-pole (a0 b1 b2 radius frequency)
...
(def-optkey-fun make-two-zero (a0 a1 a2 radius frequency)
