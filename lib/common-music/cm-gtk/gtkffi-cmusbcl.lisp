;;; Output by lambda-gtk on 6.12.2005 at 12:21:20
...
(defmacro define-signal-handler (name return params &body body)
  (let ((args
    ...
    #+:sbcl
    `(defparameter ,name
       (alien-sap (sb-alien::alien-lambda ,type ,args ,@body)))
    #+:cmu
    `(def-callback ,name (,type ,@args) ,@body)))
(defmacro g::callback (x) #+:sbcl x #+:cmu `(alien::callback ,x))
...
(defalien-type GdkEventProximity
               (struct _GdkEventProximity
                       ...
                       (time guint32)
                       (device (* t))))
(defalien-type u1936_/sw/include/gtk-2.0/gtk/gtk.h
               (union _u1936_/sw/include/gtk-2.0/gtk/gtk.h
                      (b (array char 20))
                      (s (array short 10))
                      (l (array long 5))))
...
(defalien-type GdkEventClient
               (struct _GdkEventClient
                       ...
                       (data_format gushort)
                       (data (union _u1936_/sw/include/gtk-2.0/gtk/gtk.h))))
...
(defalien-type u4549_/sw/include/gtk-2.0/gtk/gtk.h
               (union _u4549_/sw/include/gtk-2.0/gtk/gtk.h
...
(defalien-type GtkImage
               (struct _GtkImage
                       ...
                       (data (union _u4549_/sw/include/gtk-2.0/gtk/gtk.h))
                       (mask (* t))
