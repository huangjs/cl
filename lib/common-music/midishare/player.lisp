...
(defvar *player* nil) ; t if player is loaded

(if (probe-file *libplayer*)
    (progn (cffi:load-foreign-library *libplayer*)
           (setq *player* t))
    (error "Midishare Player: ~a not found. Fix *libplayer* path."
           *libplayer*))
