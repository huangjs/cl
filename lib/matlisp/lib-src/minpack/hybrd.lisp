...
(let ((one 1.0d0)
  ...
  (defun hybrd
    ...
    (declare (type double-float xtol epsfcn factor)
             (type f2cl-lib:integer4 n maxfev ml mu mode nprint info nfev
              ldfjac lr)
             (type (array double-float (*)) x fvec diag fjac r qtf wa1 wa2 wa3
              wa4)
             (type
              (function
               ...
               (values &rest t))
              fcn))
    (f2cl-lib:with-array-data (wa4-%data% wa4-%offset% wa4)
      (declare (type f2cl-lib:integer4 wa4-%offset%)
               (type (simple-array double-float (*)) wa4-%data%)
               (ignorable wa4-%offset% wa4-%data%))
      (f2cl-lib:with-array-data (wa3-%data% wa3-%offset% wa3)
        (declare (type f2cl-lib:integer4 wa3-%offset%)
                 (type (simple-array double-float (*)) wa3-%data%)
                 (ignorable wa3-%offset% wa3-%data%))
        (f2cl-lib:with-array-data (wa2-%data% wa2-%offset% wa2)
          ...
          (f2cl-lib:with-array-data (wa1-%data% wa1-%offset% wa1)
            ...
            (f2cl-lib:with-array-data (qtf-%data% qtf-%offset% qtf)
              (declare (type f2cl-lib:integer4 qtf-%offset%)
                       (type (simple-array double-float (*)) qtf-%data%)
                       (ignorable qtf-%offset% qtf-%data%))
                  ...
                  (f2cl-lib:with-array-data (diag-%data% diag-%offset% diag)
                    ...
                    (f2cl-lib:with-array-data (fvec-%data% fvec-%offset% fvec)
                      ...
                      (f2cl-lib:with-array-data (x-%data% x-%offset% x)
                        ...
                        (prog ((actred 0.0d0) (delta 0.0d0) (epsmch 0.0d0)
                               (fnorm 0.0d0) (fnorm1 0.0d0) (pnorm 0.0d0)
                               (prered 0.0d0) (ratio 0.0d0) (sum 0.0d0)
                               (temp 0.0d0) (xnorm 0.0d0) (jeval nil)
                               (sing nil)
                               (iwa
                                (make-array 1
                                            :element-type
                                            'f2cl-lib:integer4))
                               (i 0) (iflag 0) (iter 0) (j 0) (jm1 0) (l 0)
                               (msum 0) (ncfail 0) (ncsuc 0) (nslow1 0)
                               (nslow2 0))
                          (declare
                           (type f2cl-lib:integer4 nslow2 nslow1 ncsuc ncfail
                            msum l jm1 j iter iflag i)
                           (type (array f2cl-lib:integer4 (1)) iwa)
                           (type f2cl-lib:logical sing jeval)
                           (type double-float xnorm temp sum ratio prered pnorm
                            fnorm1 fnorm epsmch delta actred))
                          '"     **********"
                          '""
                          '"     subroutine hybrd"
                          '""
                         ...
                         label20
                          ...
                          '""
                          (setf msum
                                  (f2cl-lib:min0 (f2cl-lib:int-add ml mu 1) n))
                          '""
                         ...
                         label30
                          ...
                          (multiple-value-bind
                              ...
                              (fdjac1 fcn n x fvec fjac ldfjac iflag ml mu
                               epsfcn wa1 wa2)
                            (declare
                             (ignore var-0 var-2 var-3 var-4 var-5 var-7 var-8
                              var-9 var-10 var-11))
                            (setf n var-1)
                            (setf iflag var-6))
                          ...
                          '""
                          (qrfac n n fjac ldfjac f2cl-lib:%false% iwa 1 wa1 wa2
                           wa3)
                          '""
                         ...
                         label260
                          ...
                          (if
                           (<= (* p1 (f2cl-lib:dmax1 (* p1 delta) pnorm))
                               (* epsmch xnorm))
                           (setf info 3))
