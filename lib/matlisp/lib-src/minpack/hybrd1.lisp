...
(let ((factor 100.0d0) (one 1.0d0) (zero 0.0d0))
  ...
  (defun hybrd1 (fcn n x fvec tol info wa lwa)
    (declare (type double-float tol)
             ...
             (type f2cl-lib:integer4 n info lwa))
    (f2cl-lib:with-array-data (wa-%data% wa-%offset% wa)
      ...
      (f2cl-lib:with-array-data (fvec-%data% fvec-%offset% fvec)
        ...
        (f2cl-lib:with-array-data (x-%data% x-%offset% x)
          ...
          (prog ((epsfcn 0.0d0) (xtol 0.0d0) (f2cl-lib:index 0) (j 0) (lr 0)
                 (maxfev 0) (ml 0) (mode 0) (mu 0) (nfev 0) (nprint 0))
            (declare
             (type f2cl-lib:integer4 nprint nfev mu mode ml maxfev lr j
              f2cl-lib:index)
            ...
            (f2cl-lib:fdo (j 1 (f2cl-lib:int-add j 1))
              ...
              (tagbody
                (f2cl-lib:fset
                 (f2cl-lib:fref wa-%data% (j) ((1 lwa)) wa-%offset%)
                 one)
               label10))
            (setf nprint 0)
            (setf lr (the f2cl-lib:integer4 (truncate (* n (+ n 1)) 2)))
            (setf f2cl-lib:index (f2cl-lib:int-add (f2cl-lib:int-mul 6 n) lr))
            (multiple-value-bind
              ...
              (declare
               (ignore var-0 var-2 var-3 var-4 var-5 var-6 var-7 var-8 var-9
                var-10 var-11 var-12 var-15 var-16 var-17 var-18 var-19 var-20
