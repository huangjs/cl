...
(let ((factor 100.0d0) (one 1.0d0) (zero 0.0d0))
  ...
  (defun hybrj1 (fcn n x fvec fjac ldfjac tol info wa lwa)
    (declare (type double-float tol)
             ...
             (type f2cl-lib:integer4 n ldfjac info lwa))
      ...
      (f2cl-lib:with-array-data (fjac-%data% fjac-%offset% fjac)
        ...
        (f2cl-lib:with-array-data (fvec-%data% fvec-%offset% fvec)
          ...
          (f2cl-lib:with-array-data (x-%data% x-%offset% x)
            ...
            (prog ((xtol 0.0d0) (j 0) (lr 0) (maxfev 0) (mode 0) (nfev 0)
                   (njev 0) (nprint 0))
              (declare
               (type f2cl-lib:integer4 nprint njev nfev mode maxfev lr j)
