  ...
  (defun lmder
    ...
    (declare (type (array f2cl-lib:integer4 (*)) ipvt)
             ...
             (type (array double-float (*)) wa4 wa3 wa2 wa1 qtf diag fjac fvec
              x)
             (type f2cl-lib:integer4 njev nfev info nprint mode maxfev ldfjac n
              m)
             (type single-float fcn)
             (type
              (function
               (f2cl-lib:integer4 f2cl-lib:integer4 f2cl-lib:array-double-float
                f2cl-lib:array-double-float f2cl-lib:array-double-float
                f2cl-lib:integer4 f2cl-lib:integer4)
               (values &rest t))
              fcn))
