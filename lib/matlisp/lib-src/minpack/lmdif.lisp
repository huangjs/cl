...
(let ((one 1.0d0)
  ...
  (defun lmdif
    ...
    (declare (type double-float ftol xtol gtol epsfcn factor)
             (type f2cl-lib:integer4 m n maxfev mode nprint info nfev ldfjac)
                  ...
                  (f2cl-lib:with-array-data (fvec-%data% fvec-%offset% fvec)
                    ...
                    (f2cl-lib:with-array-data (x-%data% x-%offset% x)
                      ...
                      (f2cl-lib:with-array-data (ipvt-%data% ipvt-%offset% ipvt)
                        ...
                        (prog ((actred 0.0d0) (delta 0.0d0) (dirder 0.0d0)
                               (epsmch 0.0d0) (fnorm 0.0d0) (fnorm1 0.0d0)
                               (gnorm 0.0d0) (par 0.0d0) (pnorm 0.0d0)
                               (prered 0.0d0) (ratio 0.0d0) (sum 0.0d0)
                               (temp 0.0d0) (temp1 0.0d0) (temp2 0.0d0)
                               (xnorm 0.0d0) (i 0) (iflag 0) (iter 0) (j 0)
                               (l 0))
                          (declare (type f2cl-lib:integer4 l j iter iflag i)
                                   (type double-float xnorm temp2 temp1 temp
                                    sum ratio prered pnorm par gnorm fnorm1
                                    fnorm epsmch dirder delta actred))
                          '"     **********"
                          '""
                          '"     subroutine lmdif"
                          '""
                         ...
                         label30
                          ...
                          (multiple-value-bind
                              (var-0 var-1 var-2 var-3 var-4 var-5 var-6 var-7
                               var-8 var-9)
                              (fdjac2 fcn m n x fvec fjac ldfjac iflag epsfcn
                               wa4)
                            (declare
                             (ignore var-0 var-3 var-4 var-5 var-6 var-8
                              var-9))
                            (setf m var-1)
                            (setf n var-2)
                            (setf iflag var-7))
                         ...
                         label40
                          ...
                          '""
                          (qrfac m n fjac ldfjac f2cl-lib:%true% ipvt n wa1 wa2
                           wa3)
                          '""
                         ...
                         label200
                          ...
                          (if (or (>= (* p1 fnorm1) fnorm) (< temp p1))
                              (setf temp p1))
                          (setf delta
                                  (* temp (f2cl-lib:dmin1 delta (/ pnorm p1))))
                          (setf par (/ par temp))
                          (go label260)
                         label240
