            ...
            (f2cl-lib:with-array-data (sdiag-%data% sdiag-%offset% sdiag)
              ...
              (f2cl-lib:with-array-data (wa-%data% wa-%offset% wa)
                ...
                (f2cl-lib:with-array-data (ipvt-%data% ipvt-%offset% ipvt)
                  ...
                  (prog ((cos 0.0d0) (cotan 0.0d0) (qtbpj 0.0d0) (sin 0.0d0)
                         (sum 0.0d0) (tan 0.0d0) (temp 0.0d0) (i 0) (j 0)
                         (jp1 0) (k 0) (kp1 0) (l 0) (nsing 0))
                    (declare (type f2cl-lib:integer4 nsing l kp1 k jp1 j i)
                             (type double-float temp tan sum sin qtbpj cotan
                              cos))
                    '"     **********"
                    '""
                    '"     subroutine qrsolv"
