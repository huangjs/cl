...
(let ((one 1.0d0) (p5 0.5d0) (p25 0.25d0) (zero 0.0d0))
  ...
  (defun r1updt (m n s ls u v w sing)
    ...
    (f2cl-lib:with-array-data (s-%data% s-%offset% s)
      (declare (type f2cl-lib:integer4 s-%offset%)
               (type (simple-array double-float (*)) s-%data%)
               (ignorable s-%offset% s-%data%))
      (f2cl-lib:with-array-data (u-%data% u-%offset% u)
        (declare (type f2cl-lib:integer4 u-%offset%)
                 (type (simple-array double-float (*)) u-%data%)
                 (ignorable u-%offset% u-%data%))
        (f2cl-lib:with-array-data (v-%data% v-%offset% v)
          ...
          (f2cl-lib:with-array-data (w-%data% w-%offset% w)
            ...
            (prog ((cos 0.0d0) (cotan 0.0d0) (giant 0.0d0) (sin 0.0d0)
                   (tan 0.0d0) (tau 0.0d0) (temp 0.0d0) (i 0) (j 0) (jj 0)
                   (l 0) (nmj 0) (nm1 0))
              ...
              (f2cl-lib:fdo (nmj 1 (f2cl-lib:int-add nmj 1))
                ...
                (tagbody
                  ...
                  (setf sin
                          (/ p5
                             (f2cl-lib:dsqrt (+ p25 (* p25 (expt cotan 2))))))
                  (setf cos (* sin cotan))
                  (setf tau one)
                 ...
                 label20
                  (setf tan
                          (/ (f2cl-lib:fref v-%data% (j) ((1 n)) v-%offset%)
                             (f2cl-lib:fref v-%data% (n) ((1 n)) v-%offset%)))
                  (setf cos
                          (/ p5 (f2cl-lib:dsqrt (+ p25 (* p25 (expt tan 2))))))
                  (setf sin (* cos tan))
                  (setf tau sin)
                 label30
                  '""
                  ...
                  (f2cl-lib:fset
                   ...
                   (+ (* sin (f2cl-lib:fref v-%data% (j) ((1 n)) v-%offset%))
                      (* cos (f2cl-lib:fref v-%data% (n) ((1 n)) v-%offset%))))
                  (f2cl-lib:fset
                   (f2cl-lib:fref v-%data% (j) ((1 n)) v-%offset%)
                   tau)
                  '""
              ...
              (f2cl-lib:fdo (j 1 (f2cl-lib:int-add j 1))
                ...
                (tagbody
                 ...
                 label120
                  ...
                  '""
                  (if
                   (= (f2cl-lib:fref s-%data% (jj) ((1 ls)) s-%offset%) zero)
