    ...
    (let ()
      (symbol-macrolet ((njev (refnum-njev *refnum-common-block*))
        ...
        (prog ((ntries 0) (n 0) (m 0) (lwa 0) (k 0) (info 0) (ic 0) (i 0)
               (nx (make-array 60 :element-type 'f2cl-lib:integer4))
          ...
          (declare (type (array double-float (60)) fnm)
                   ...
                   (type f2cl-lib:integer4 i ic info k lwa m n ntries))
          '"     **********"
          '""
          ...
          (f2cl-lib:fdo (k 1 (f2cl-lib:int-add k 1))
            ...
            (tagbody
              ...
              (multiple-value-bind
                ...
                (declare (ignore var-0 var-3 var-4 var-5 var-7 var-8 var-9))
                (setf m var-1)
                (setf n var-2)
                (setf info var-6))
              (multiple-value-bind
              ...
              (setf njev (the f2cl-lib:integer4 (truncate njev n)))
...
(defun fcn (m n x fvec iflag)
  (declare (type (array double-float (*)) fvec x)
           (type f2cl-lib:integer4 iflag n m))
  (let ()
    (symbol-macrolet ((njev (refnum-njev *refnum-common-block*))
                      (nfev (refnum-nfev *refnum-common-block*))
                      (nprob (refnum-nprob *refnum-common-block*)))
