...
(defun dqagse
  ...
  (f2cl-lib:with-multi-array-data
    ...
    (prog ((res3la (make-array 3 :element-type 'double-float))
           ...
           (errbnd 0.0d0) (errmax 0.0d0) (error1 0.0d0) (error2 0.0d0)
           (erro12 0.0d0) (errsum 0.0d0) (ertest 0.0d0) (oflow 0.0d0)
           (resabs 0.0d0) (reseps 0.0d0) (small 0.0d0) (uflow 0.0d0))
      (declare (type (array double-float (52)) rlist2)
       ...
       (type double-float uflow small reseps resabs oflow ertest errsum erro12
        ...
        defabs correc b2 b1 a2 a1 area2 area12 area1 area abseps)
      ...
      (f2cl-lib:fdo (last$ 2 (f2cl-lib:int-add last$ 1))
        ...
        (tagbody
         ...
         label70
          ...
          (go label90)
         label80
          (setf small (* (f2cl-lib:dabs (- b a)) 0.375d0))
          (setf erlarg errsum)
          (setf ertest errbnd)
