...
(defun dqawse
  ...
  (f2cl-lib:with-multi-array-data
    ...
    (prog ((ri (make-array 25 :element-type 'double-float))
           ...
           (iroff2 0) (k 0) (maxerr 0) (nev 0) (nrmax 0) (area 0.0d0)
           (area1 0.0d0) (area12 0.0d0) (area2 0.0d0) (a1 0.0d0) (a2 0.0d0)
           (b1 0.0d0) (b2 0.0d0) (centre 0.0d0) (epmach 0.0d0) (errbnd 0.0d0)
           (errmax 0.0d0) (error1 0.0d0) (erro12 0.0d0) (error2 0.0d0)
           (errsum 0.0d0) (resas1 0.0d0) (resas2 0.0d0) (uflow 0.0d0))
      (declare (type (array double-float (25)) rj ri rh rg)
       (type double-float uflow resas2 resas1 errsum error2 erro12 error1
        errmax errbnd epmach centre b2 b1 a2 a1 area2 area12 area1 area)
      ...
      (f2cl-lib:fset
       ...
       a)
      (f2cl-lib:fset
       (f2cl-lib:fref alist-%data% (2) ((1 limit)) alist-%offset%)
       centre)
      (f2cl-lib:fset
       (f2cl-lib:fref blist-%data% (1) ((1 limit)) blist-%offset%)
       centre)
      (f2cl-lib:fset
       (f2cl-lib:fref blist-%data% (2) ((1 limit)) blist-%offset%)
       b)
      (f2cl-lib:fset
       (f2cl-lib:fref rlist-%data% (1) ((1 limit)) rlist-%offset%)
       area1)
      (f2cl-lib:fset
       (f2cl-lib:fref rlist-%data% (2) ((1 limit)) rlist-%offset%)
       area2)
      (f2cl-lib:fset
       (f2cl-lib:fref elist-%data% (1) ((1 limit)) elist-%offset%)
       error1)
      (f2cl-lib:fset
       (f2cl-lib:fref elist-%data% (2) ((1 limit)) elist-%offset%)
       error2)
      (go label20)
     label10
      (f2cl-lib:fset
     ...
     label20
      (f2cl-lib:fset (f2cl-lib:fref iord-%data% (1) ((1 limit)) iord-%offset%)
                     1)
      (f2cl-lib:fset (f2cl-lib:fref iord-%data% (2) ((1 limit)) iord-%offset%)
                     2)
