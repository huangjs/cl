  ...
  (defun dqc25f
    ...
    (f2cl-lib:with-multi-array-data
      ...
      (prog ((cheb12 (make-array 13 :element-type 'double-float))
             ...
             (isym 0) (j 0) (k 0) (m 0) (noequ 0) (noeq1 0) (ac 0.0d0)
             (an 0.0d0) (an2 0.0d0) (as 0.0d0) (asap 0.0d0) (ass 0.0d0)
             (centr 0.0d0) (conc 0.0d0) (cons$ 0.0d0) (cospar 0.0d0)
             (estc 0.0d0) (ests 0.0d0) (hlgth 0.0d0) (oflow 0.0d0)
             (parint 0.0d0) (par2 0.0d0) (par22 0.0d0) (p2 0.0d0) (p3 0.0d0)
             (p4 0.0d0) (resc12 0.0d0) (resc24 0.0d0) (ress12 0.0d0)
             (ress24 0.0d0) (sinpar 0.0d0))
        (declare (type (array double-float (28)) v)
         (type (array double-float (25)) fval d2 d1 d cheb24)
         (type (array double-float (13)) cheb12)
         (type double-float sinpar ress24 ress12 resc24 resc12 p4 p3 p2 par22
          par2 parint oflow hlgth ests estc cospar cons$ conc centr ass asap as
          an2 an ac)
        ...
        (if (> (f2cl-lib:dabs parint) 2.0d0) (go label10))
        (multiple-value-bind
        ...
        (f2cl-lib:fset (f2cl-lib:fref v (3) ((1 28)))
                       (/
                        (+ (* 32.0d0 (- par2 12.0d0) cospar)
                           (/
                            (* 2.0d0
                               (+ (* (- par2 80.0d0) par2) 192.0d0)
                               sinpar)
                            parint))
                        (* par2 par2)))
        (setf ac (* 8.0d0 cospar))
        (setf as (* 24.0d0 parint sinpar))
        (if (> (f2cl-lib:dabs parint) 24.0d0) (go label30))
        (setf noequ 25)
       ...
       label50
        ...
        (if (> (f2cl-lib:dabs parint) 24.0d0) (go label80))
        (setf an 5.0d0)
        (f2cl-lib:fdo (k 1 (f2cl-lib:int-add k 1))
                      ((> k noeq1) nil)
          (tagbody
        ...
        (f2cl-lib:fset (f2cl-lib:fref v (3) ((1 28)))
                       (+ (f2cl-lib:fref v (3) ((1 28)))
                          (* -42.0d0 par2 (f2cl-lib:fref v (2) ((1 28))))))
