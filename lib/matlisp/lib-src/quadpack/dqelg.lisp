...
(defun dqelg (n epstab result abserr res3la nres)
  (declare (type (array double-float (*)) res3la)
   (type double-float abserr result) (type (array double-float (*)) epstab)
  ...
  (f2cl-lib:with-multi-array-data
    ...
    (prog ((i 0) (ib 0) (ib2 0) (ie 0) (indx 0) (k1 0) (k2 0) (k3 0) (limexp 0)
           (newelm 0) (num 0) (delta1 0.0d0) (delta2 0.0d0) (delta3 0.0d0)
           (epmach 0.0d0) (epsinf 0.0d0) (err1 0.0d0) (err2 0.0d0) (err3 0.0d0)
           (e0 0.0d0) (e1 0.0d0) (e1abs 0.0d0) (e2 0.0d0) (e3 0.0d0)
           (oflow 0.0d0) (res 0.0d0) (ss 0.0d0) (tol1 0.0d0) (tol2 0.0d0)
           (tol3 0.0d0) (error$ 0.0d0))
      (declare
       (type double-float error$ tol3 tol2 tol1 ss res oflow e3 e2 e1abs e1 e0
        err3 err2 err1 epsinf epmach delta3 delta2 delta1)
     ...
     label100
      (setf abserr
              (f2cl-lib:dmax1 abserr (* 5.0d0 epmach (f2cl-lib:dabs result))))
      (go end_label)
     end_label
