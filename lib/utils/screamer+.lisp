...
#+unix (defparameter *screamer+-path* "/home/hjs/.sbcl/lib/utils/")
#+darwin (defparameter *screamer+-path* "/User/huangjianshi/.sbcl/lib/utils/")

;;; Derive path of SCREAMER assuming it is in a subdirectory of the
;;; SCREAMER+ directory
#+unix (defparameter *screamer-path* "/home/hjs/.sbcl/lib/clocc/src/screamer/")
#+darwin (defparameter *screamer-path* "/User/huangjianshi/.sbcl/lib/clocc/src/screamer/")
...
(defun slot-names-of (obj)
  (mapcar #'(lambda(x) (slot-value x
				   #+allegro 'CLOS::NAME
				   #+sbcl 'sb-pcl::name))
	  #+allegro (clos::class-slots (class-of obj))
	  #+sbcl (sb-pcl::class-slots (class-of obj))
	  )
  )
...
#+allegro (setq excl:*enable-package-locked-errors* t)
